...
ALTER TABLE group_email ADD CONSTRAINT allowed_email_group
...
ALTER TABLE company_profile ADD CONSTRAINT company_profile_user
    FOREIGN KEY (user_id)
        REFERENCES "user" (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE interest ADD CONSTRAINT company_user
...
ALTER TABLE internship ADD CONSTRAINT internship_user
    FOREIGN KEY (company_user_id)
        REFERENCES "user" (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE preferred_city ADD CONSTRAINT preferred_city_city
    FOREIGN KEY (city_id)
        REFERENCES city (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE preferred_city ADD CONSTRAINT preferred_city_user
    FOREIGN KEY (user_id)
        REFERENCES "user" (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE student_profile ADD CONSTRAINT profile_user
    FOREIGN KEY (user_id)
        REFERENCES "user" (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE student_preference ADD CONSTRAINT student_preference_user
    FOREIGN KEY (user_id)
        REFERENCES "user" (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE interest ADD CONSTRAINT student_user
...
ALTER TABLE task_answer ADD CONSTRAINT task_answer_task
    FOREIGN KEY (task_id)
        REFERENCES task (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE task_answer ADD CONSTRAINT task_answer_user
    FOREIGN KEY (user_id)
        REFERENCES "user" (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE user_task ADD CONSTRAINT user_task_task
    FOREIGN KEY (task_id)
        REFERENCES task (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
