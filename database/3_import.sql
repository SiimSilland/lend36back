...
INSERT INTO lend."group" (id, number, period, lector_name, status) VALUES (default, 36, 'jan 25 - feb 25', 'Rain', 'A');
INSERT INTO lend."group" (id, number, period, lector_name, status) VALUES (default, 37, 'aprill 25 - mai 25', 'Rain', 'A');

INSERT INTO lend.group_email (id, group_id, first_name, last_name, email, status) VALUES (default, 1, 'Siim', 'Silland', 'siim@mail.ee', 'P');
INSERT INTO lend.group_email (id, group_id, first_name, last_name, email, status) VALUES (default, 1, 'Krisse', 'Talts', 'krisse@mail.ee', 'P');
INSERT INTO lend.group_email (id, group_id, first_name, last_name, email, status) VALUES (default, 1, 'Kalle', 'Bammer', 'kalle@mail.ee', 'P');
